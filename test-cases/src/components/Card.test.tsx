...
jest.mock('lucide-react', () => ({
  Users: ({ size, ...props }: any) => <div data-testid="icon-users" data-size={size} {...props} />,
  CheckCircle: ({ size, ...props }: any) => <div data-testid="icon-check-circle" data-size={size} {...props} />,
}))
...
describe('Card Component', () => {
  ...
  describe('UserCard Component', () => {
    ...
    test('applies correct status styling', () => {
      const { rerender } = render(<UserCard user={{...mockUser, status: 'active'}} />)
  ...
  describe('ProjectCard Component', () => {
    ...
    test('handles team with avatars', () => {
      ...
      expect(avatars[1]).toHaveAttribute('src', 'https://example.com/sarah.jpg')
    })
  })
})