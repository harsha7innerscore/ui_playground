...
class GitHubClient:
    ...
    def set_access_token(self, access_token: str):
        """Set a new access token for subsequent requests."""
        self.access_token = access_token
        self._update_auth_header()
...
# Helper function to create GitHub client with user access token
def create_github_client(access_token: str) -> GitHubClient:
    """Create a GitHub client instance with user access token."""
    return GitHubClient(access_token)

# Global github instance for agent tools
# This gets set when a user authenticates
github = None
