  ...
  return (
    <>
      <Box className={Styles?.globalContainer} data-testid="box-1">
            ...
            <Box className={Styles?.globalSubbContainer} data-testid="box-box-2">
              ...
              <Box className={Styles?.optionRightContainer} data-testid="box-box-4">
                <LearningCreditsContainer
                 ...
                 data-testid="box-learningcreditscontainer-1" />
                <Box className={Styles?.optionRightTopContainer} data-testid="box-box-5">
                  <OptionContainer
                   ...
                   data-testid="box-optioncontainer-1" />
                </Box>
                  ...
                  {isNotEmptyOrNull(data) ? (
                    data?.map((item, index) => {
                      ...
                      return (
                        <Box
                          ...
                          key={index}
                          cursor={"pointer"}
                          onClick={() = data-testid="box-individualContainer-1"> onhandleUpdateClick(item)}
                        >
                   ...
                   with the subtopics assgined, else the icon will be shown */}
                            ...
                            <VStack
                              ...
                              spacing={"8px"}
                              align={"start"}
                             data-testid="vstack-updateContentBox-1">
                    ...
                    <Box className={Styles.noUpdates} data-testid="box-noUpdates-1">
                      <Image
                       ...
                       data-testid="image-noUpdatesImage-1" />
        ...
        {/* PLAIN INPUT */}
        {isMobile && (
          <Box sx={TaskScreenStyles(isMobile)?.bottomInput} data-testid="box-box-7">
            {editor()}
            <Box sx={TaskScreenStyles()?.bottomBox} data-testid="box-box-8"></Box>
          </Box>
        )}
      </Box>
